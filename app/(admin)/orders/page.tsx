  ...
  return (
    <div className="mx-auto max-w-6xl p-8">
      ...
      <div className="mb-8 grid grid-cols-2 gap-4 md:grid-cols-4">
        ...
        >
          <p className={`text-xs font-medium uppercase tracking-wide opacity-100 ${
            statusFilter === "pending" ? "text-white" : "text-zinc-900"
          }`}>
            Pending
          </p>
        ...
        >
          <p className={`text-xs font-medium uppercase tracking-wide opacity-100 ${
            statusFilter === "confirmed" ? "text-white" : "text-zinc-900"
          }`}>
            Confirmed
          </p>
        ...
        >
          <p className={`text-xs font-medium uppercase tracking-wide opacity-100 ${
            statusFilter === "in_production" ? "text-white" : "text-zinc-900"
          }`}>
            In Production
          </p>
        ...
        >
          <p className={`text-xs font-medium uppercase tracking-wide opacity-100 ${
            statusFilter === "completed" ? "text-white" : "text-zinc-900"
          }`}>
            Completed
          </p>
      ...
      <div className="mb-6 rounded-xl border bg-white p-4">
        ...
        <input
          ...
          className="w-full rounded-lg border bg-zinc-50 px-4 py-3 text-sm text-zinc-900 outline-none focus:border-zinc-400 focus:bg-white"
        />
      ...
      {isLoading ? (
        ...
        <div className="overflow-x-auto rounded-xl border bg-white">
          <table className="w-full text-sm">
            <thead className="border-b bg-zinc-50 text-left text-xs uppercase tracking-wide text-zinc-800">
              <tr>
            ...
            <tbody>
              {filteredOrders.map((order) => (
                <tr key={order.id} className="border-b last:border-0">
                  ...
                  <td className="px-4 py-3 font-medium text-zinc-900">{order.customer_name}</td>
                  <td className="px-4 py-3 text-zinc-900">{order.product}</td>
                  ...
                  <td className="px-4 py-3">
                    <select
                      ...
                      className={`rounded-full border-0 px-2 py-1 text-xs font-medium ${
                        STATUS_STYLES[order.status] ?? "bg-zinc-100 text-zinc-800"
                      }`}
                    >
